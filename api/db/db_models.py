...
class EvaluationRun(DataBaseModel):
    ...
    judge_status = CharField(max_length=32, null=True, help_text="LLM judge status: null/RUNNING/OK/FAILED/CANCELLED")
    judge_progress = FloatField(null=True, default=0.0, help_text="judge progress 0.0-1.0")
    judge_progress_msg = CharField(max_length=32, null=True, help_text="human-readable judge progress e.g. 2/10")
...
def migrate_db():
    ...
    alter_db_add_column(migrator, "evaluation_runs", "judge_status", CharField(max_length=32, null=True, help_text="LLM judge status: null/RUNNING/OK/FAILED/CANCELLED"))
    alter_db_add_column(migrator, "evaluation_runs", "judge_progress", FloatField(null=True, default=0.0, help_text="judge progress 0.0-1.0"))
    alter_db_add_column(migrator, "evaluation_runs", "judge_progress_msg", CharField(max_length=32, null=True, help_text="human-readable judge progress e.g. 2/10"))
