...
const Switch = React.forwardRef<
  ...
  SwitchProps
>(({ className, intermediate = false, ...props }, ref) => (
  <SwitchPrimitives.Root
    className={cn(
      ...
      intermediate && 'bg-text-sub-title',
      className,
    )}
    data-intermediate={intermediate ? 'true' : undefined}
    {...props}
    ref={ref}
  >
    <SwitchPrimitives.Thumb
      ...
      `,
        intermediate &&
          '!translate-x-[6px] group-hover/switch:!translate-x-[6px] group-focus-visible/switch:!translate-x-[6px]',
      )}
    />
  </SwitchPrimitives.Root>
));
