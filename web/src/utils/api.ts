...
export default {
  ...
  duplicate_kb: `${api_host}/kb/duplicate`,
  ...
  duplicateDialog: `${api_host}/dialog/duplicate`,
  ...
  duplicateCanvas: `${api_host}/canvas/duplicate`,
  ...
  duplicateSearch: `${api_host}/search/duplicate`,
